...
const TargetSizeInput = ({
  ...
  return (
    <div className="mb-6 p-6 bg-gradient-to-br from-orange-900/20 via-yellow-900/20 to-red-900/20 rounded-2xl shadow-lg border border-orange-800">
      ...
      <div className="flex flex-col sm:flex-row sm:space-x-4 space-y-4 sm:space-y-0">
        <div className="flex-1">
          <input
            ...
            placeholder="e.g., 500"
            className="w-full px-4 py-3 border-2 border-gray-600 rounded-xl 
                     bg-gray-800 text-gray-100
                     focus:border-orange-500 focus:ring-2 focus:ring-orange-800 focus:outline-none transition-all duration-200"
            min="1"
            step="0.1"
          />
          {error && (
        ...
        <div className="flex rounded-xl overflow-hidden border-2 border-gray-600 shadow-sm">
          <button
